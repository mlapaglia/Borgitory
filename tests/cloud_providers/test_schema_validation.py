...
class TestRegistryValidation:
    ...
    def test_validate_s3_config_missing_required_field(self):
    ...
    def test_validate_sftp_config_valid(self):
    ...
    def test_validate_sftp_config_missing_required_field(self):
    ...
    def test_validate_smb_config_valid(self):
...
class TestCloudSyncConfigCreateValidation:
    ...
    def test_create_config_valid_s3(self):
    ...
    def test_create_config_valid_sftp(self):
    ...
    def test_create_config_valid_smb(self):
    ...
    def test_create_config_invalid_s3(self):
    ...
    def test_create_config_empty_provider_config(self):
    ...
    def test_create_config_missing_provider_config(self):
...
class TestCloudSyncConfigUpdateValidation:
    ...
    def test_update_config_valid_s3(self):
    ...
    def test_update_config_provider_only(self):
    ...
    def test_update_config_invalid_when_both_provided(self):
    ...
    def test_update_config_empty_provider_config(self):
