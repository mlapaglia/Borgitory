...
class MockStorage(CloudStorage):
    ...
    def __init__(
        self, rclone_service: RcloneService, config: CloudStorageConfig
    ) -> None:
        super().__init__()
    ...
    def get_rclone_config_section(self) -> Dict[str, object]:
        return {}
...
class TestProviderValidation:
    ...
    def test_is_provider_registered_function(self, clean_registry: None) -> None:
...
class TestPydanticValidation:
    ...
    def test_create_config_with_valid_provider(self) -> None:
    ...
    def test_create_config_with_invalid_provider(self) -> None:
    ...
    def test_create_config_with_empty_provider(self) -> None:
    ...
    def test_update_config_with_valid_provider(self) -> None:
    ...
    def test_update_config_with_invalid_provider(self) -> None:
    ...
    def test_update_config_with_none_provider(self) -> None:
        """Test CloudSyncConfigUpdate with None provider (should be allowed)"""
        update_data: Dict[str, Any] = {"name": "Updated Name"}
    ...
    def test_validation_reflects_registry_changes(self) -> None:
    ...
    def test_base_config_provider_validation(self) -> None:
    ...
    def test_error_message_includes_supported_providers(self) -> None:
