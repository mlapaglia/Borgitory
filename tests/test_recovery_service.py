...
class TestRecoveryService:
    ...
    async def test_recover_stale_jobs(self, recovery_service):
        ...
        with patch.object(recovery_service, 'recover_database_job_records') as mock_recover:
            await recovery_service.recover_stale_jobs()
            
            mock_recover.assert_called_once()

    @pytest.mark.asyncio
    async def test_recover_database_job_records_no_interrupted_jobs(self, recovery_service):
    ...
    @pytest.mark.asyncio
    async def test_recover_database_job_records_with_interrupted_jobs(self, recovery_service, mock_job, mock_task, mock_repository):
    ...
    @pytest.mark.asyncio
    async def test_recover_database_job_records_backup_job_no_repository(self, recovery_service):
    ...
    @pytest.mark.asyncio
    async def test_release_repository_lock_success(self, recovery_service, mock_repository):
    ...
    @pytest.mark.asyncio
    async def test_release_repository_lock_command_failure(self, recovery_service, mock_repository):
    ...
    @pytest.mark.asyncio
    async def test_release_repository_lock_timeout(self, recovery_service, mock_repository):
    ...
    @pytest.mark.asyncio
    async def test_release_repository_lock_no_stderr(self, recovery_service, mock_repository):
    ...
    @pytest.mark.asyncio
    async def test_recover_database_job_records_job_without_repository_id(self, recovery_service):
    ...
    @pytest.mark.asyncio
    async def test_recover_database_job_records_multiple_task_statuses(self, recovery_service):
