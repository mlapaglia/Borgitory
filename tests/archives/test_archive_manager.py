...
class TestArchiveManager:
    ...
    async def test_list_archive_directory_contents_success(
        ...
        with patch(
            "services.archives.archive_mount_manager.get_archive_mount_manager"
        ) as mock_get_manager:
    ...
    def test_validate_archive_path_valid(self, archive_manager):
        ...
        with patch(
            "services.archives.archive_manager.validate_archive_name"
        ) as mock_validate_archive:
            with patch(
                "services.archives.archive_manager.sanitize_path"
