...
class TestRepositoryModel:
    ...
    def setup_method(self):
        ...
        with patch('app.models.database.get_cipher_suite', return_value=self.mock_cipher):
...
class TestEncryptionSecurity:
    ...
    def test_encryption_with_different_keys(self):
        ...
        with patch('app.config.get_secret_key', return_value='key2_32_chars_long_for_testing!'):
            app.models.database._cipher_suite = None
