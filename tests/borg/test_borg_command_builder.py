...
class TestBorgCommandBuilder:
    ...
    def test_build_backup_command_default(self, mock_validate_archive, mock_validate_compression, mock_build_secure):
        ...
        assert any(arg.startswith("/test/repo/path::backup-") for arg in additional_args)
    ...
    def test_build_initialize_repository_command(self, mock_build_secure):
        ...
        command, env = self.builder.build_initialize_repository_command(self.mock_repository)
    ...
    def test_validate_command_parameters_no_repository(self):
    ...
    def test_validate_command_parameters_empty_repository_path(self):
    ...
    def test_validate_command_parameters_minimal_valid(self):
        """Test parameter validation with only repository (minimal valid case)"""
        errors = self.builder.validate_command_parameters(repository=self.mock_repository)
