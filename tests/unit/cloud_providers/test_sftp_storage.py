...
class TestSFTPStorageConfig:
    ...
    def test_valid_config_with_password(self) -> None:
        ...
        assert config.host == "nas.example.com"
        assert config.username == "backup"
    ...
    def test_valid_config_with_private_key(self) -> None:
        config = SFTPStorageConfig(
            host="nas.example.com",
            username="backup",
            remote_path="/backups",
    ...
    def test_requires_auth_method(self) -> None:
        with pytest.raises(
    ...
    def test_invalid_host_starts_with_period(self) -> None:
    ...
    def test_remote_path_prepends_slash(self) -> None:
        config = SFTPStorageConfig(
            host="nas.example.com",
            username="backup",
            remote_path="backups",
    ...
    def test_remote_path_strips_trailing_slash(self) -> None:
        config = SFTPStorageConfig(
            host="nas.example.com",
            username="backup",
            remote_path="/backups/",
    ...
    def test_invalid_remote_path_characters(self) -> None:
        with pytest.raises(ValueError, match="Remote path contains invalid characters"):
            SFTPStorageConfig(
                host="nas.example.com",
                username="backup",
                remote_path="/backups with spaces",
                password="secret",
            )


class TestSFTPStorage:
    """Test SFTP storage implementation"""
