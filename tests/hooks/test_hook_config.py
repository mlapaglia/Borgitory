...
class TestHookConfig:
    ...
    def test_hook_config_zero_timeout_allowed(self) -> None:
        """Test that zero timeout (no timeout) is valid."""
        hook = HookConfig(name="Test Hook", command="echo 'hello'", timeout=0)
