...
class TestAuthHTMX:
    ...
    @pytest.mark.asyncio
    async def test_register_htmx_success(self, async_client: AsyncClient, test_db: Session):
    ...
    @pytest.mark.asyncio
    async def test_register_htmx_validation_error(self, async_client: AsyncClient, test_db: Session):
    ...
    @pytest.mark.asyncio
    async def test_login_htmx_success(self, async_client: AsyncClient, test_db: Session):
    ...
    @pytest.mark.asyncio
    async def test_check_users_no_users_returns_register_form(self, async_client: AsyncClient, test_db: Session):
    ...
    @pytest.mark.asyncio
    async def test_check_users_with_users_returns_login_form(self, async_client: AsyncClient, test_db: Session):
