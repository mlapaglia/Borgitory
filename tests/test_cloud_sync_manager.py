...
class TestCloudSyncManager:
    ...
    def test_init_with_defaults(self):
        ...
        with patch('app.services.cloud_sync_manager.get_db_session') as mock_get_session:
            manager = CloudSyncManager()
            assert manager._db_session_factory is mock_get_session

    @pytest.mark.asyncio
    async def test_execute_cloud_sync_task_no_config(self, cloud_sync_manager, mock_db_session):
    ...
    @pytest.mark.asyncio
    async def test_execute_cloud_sync_task_repository_not_found(self, cloud_sync_manager):
    ...
    @pytest.mark.asyncio
    async def test_execute_cloud_sync_task_config_not_found(self, cloud_sync_manager, mock_db_session):
    ...
    @pytest.mark.asyncio
    async def test_execute_cloud_sync_task_config_disabled(self, cloud_sync_manager, mock_db_session, test_cloud_config):
    ...
    @pytest.mark.asyncio
    async def test_execute_cloud_sync_task_s3_success(self, cloud_sync_manager, mock_db_session, test_cloud_config):
    ...
    @pytest.mark.asyncio
    async def test_execute_cloud_sync_task_unsupported_provider(self, cloud_sync_manager, mock_db_session, test_cloud_config):
    ...
    async def test_sync_to_s3_success(self, cloud_sync_manager, test_cloud_config):
        ...
        with patch('app.services.rclone_service.RcloneService', return_value=mock_rclone_service):
    ...
    @pytest.mark.asyncio
    async def test_sync_to_s3_rclone_import_error(self, cloud_sync_manager, test_cloud_config):
        ...
        with patch('app.services.rclone_service.RcloneService', side_effect=ImportError("Module not found")):
            result = await cloud_sync_manager._sync_to_s3(
                test_cloud_config,
                repo_data,
                capture_output
    ...
    def test_get_repository_data_success(self, cloud_sync_manager, mock_db_session, test_repository):
    ...
    def test_get_repository_data_database_error(self, cloud_sync_manager, mock_db_session_factory):
    ...
    @pytest.mark.asyncio
    async def test_validate_cloud_config_success(self, cloud_sync_manager, mock_db_session, test_cloud_config):
        ...
        cloud_sync_manager._validate_s3_config = AsyncMock(return_value={
            "valid": True,
            "provider": "s3",
            "bucket": "test-bucket",
            "region": "us-east-1"
    ...
    @pytest.mark.asyncio
    async def test_validate_cloud_config_not_found(self, cloud_sync_manager, mock_db_session):
    ...
    @pytest.mark.asyncio
    async def test_validate_cloud_config_disabled(self, cloud_sync_manager, mock_db_session, test_cloud_config):
    ...
    @pytest.mark.asyncio
    async def test_validate_cloud_config_unsupported_provider(self, cloud_sync_manager, mock_db_session, test_cloud_config):
    ...
    @pytest.mark.asyncio
    async def test_validate_s3_config_success(self, cloud_sync_manager, test_cloud_config):
    ...
    @pytest.mark.asyncio
    async def test_validate_s3_config_missing_bucket(self, cloud_sync_manager, test_cloud_config):
    ...
    @pytest.mark.asyncio
    async def test_validate_s3_config_missing_credentials(self, cloud_sync_manager, test_cloud_config):
    ...
    @pytest.mark.asyncio
    async def test_validate_s3_config_credential_error(self, cloud_sync_manager, test_cloud_config):
        """Test S3 config validation with credential decryption error."""
        # Mock get_credentials to raise exception
        test_cloud_config.get_credentials = Mock(side_effect=Exception("Decryption error"))
    ...
    @pytest.mark.asyncio
    async def test_get_sync_status_success(self, cloud_sync_manager, mock_db_session, test_cloud_config):
    ...
    @pytest.mark.asyncio
    async def test_get_sync_status_database_error(self, cloud_sync_manager, mock_db_session_factory):
    ...
    @pytest.mark.asyncio
    async def test_get_sync_status_no_created_at(self, cloud_sync_manager, mock_db_session):
