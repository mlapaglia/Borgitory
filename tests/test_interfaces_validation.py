...
from borgitory.services.volumes.volume_service import VolumeService as ConcreteVolumeService
...
def test_cloud_sync_service_implements_protocol():
    ...
    from borgitory.services.cloud_providers.service import StorageFactory, EncryptionService
...
def test_job_manager_implements_protocol():
    ...
    from borgitory.services.jobs.job_manager import JobManagerConfig, JobManagerDependencies
