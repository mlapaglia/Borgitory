...
async def get_stats_loading(request: Request, repository_id: int = None):
    ...
    return templates.TemplateResponse(
        request, "partials/statistics/loading_state.html", {"repository_id": repository_id}
    )
...
async def get_repository_statistics_progress(
    ...
    async def generate_progress():
        ...
        stats_task = asyncio.create_task(
            repository_stats_service.get_repository_statistics(repository, db, progress_callback)
        )
