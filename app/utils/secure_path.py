...
def validate_path_within_base(path: str, base_dir: str, allow_equal: bool = True) -> str:
    """
...
def create_secure_filename(base_name: str, original_filename: str = "", 
                          add_uuid: bool = True) -> str:
    """
