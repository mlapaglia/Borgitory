...
if TYPE_CHECKING:
    from app.models.database import Job, Repository, Schedule
        ...
        try:
            ...
            with self.db_session_factory() as db:
                ...
                if (status == "completed" and 
                    return_code == 0 and 
                    db_job.cloud_sync_config_id and
                    self.cloud_backup_coordinator):
    ...
    async def get_job_statistics(self) -> Dict[str, Any]:
        ...
        try:
            ...
            with self.db_session_factory() as db:
                ...
                # Jobs by type
                type_counts = (
                    db.query(Job.type, func.count(Job.id))
                    .group_by(Job.type)
                    .all()
                )
                ...
                recent_jobs = (
                    db.query(Job)
                    .filter(Job.started_at >= recent_cutoff)
                    .count()
                )
