...
Revision ID: 9ed408182d00
Revises: 
Create Date: 2025-09-05 11:18:46.790454
...
def upgrade() -> None:
    ...
    op.create_table('cleanup_configs',
    ...
    sa.Column('show_list', sa.Boolean(), nullable=True),
    sa.Column('show_stats', sa.Boolean(), nullable=True),
    sa.Column('save_space', sa.Boolean(), nullable=True),
    ...
    with op.batch_alter_table('cleanup_configs', schema=None) as batch_op:
        ...
        batch_op.create_index(batch_op.f('ix_cleanup_configs_name'), ['name'], unique=False)

    op.create_table('cloud_sync_configs',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('name', sa.String(), nullable=False),
    sa.Column('provider', sa.String(), nullable=False),
    sa.Column('bucket_name', sa.String(), nullable=True),
    sa.Column('encrypted_access_key', sa.String(), nullable=True),
    ...
    with op.batch_alter_table('cloud_sync_configs', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_cloud_sync_configs_id'), ['id'], unique=False)
        batch_op.create_index(batch_op.f('ix_cloud_sync_configs_name'), ['name'], unique=False)
    ...
    with op.batch_alter_table('notification_configs', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_notification_configs_id'), ['id'], unique=False)
        batch_op.create_index(batch_op.f('ix_notification_configs_name'), ['name'], unique=False)
    ...
    op.create_table('repository_check_configs',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('name', sa.String(), nullable=False),
    sa.Column('description', sa.String(), nullable=True),
    sa.Column('check_type', sa.String(), nullable=False),
    sa.Column('verify_data', sa.Boolean(), nullable=True),
    sa.Column('repair_mode', sa.Boolean(), nullable=True),
    sa.Column('save_space', sa.Boolean(), nullable=True),
    ...
    with op.batch_alter_table('repository_check_configs', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_repository_check_configs_id'), ['id'], unique=False)
        batch_op.create_index(batch_op.f('ix_repository_check_configs_name'), ['name'], unique=False)
    ...
    sa.ForeignKeyConstraint(['check_config_id'], ['repository_check_configs.id'], ),
    sa.ForeignKeyConstraint(['cleanup_config_id'], ['cleanup_configs.id'], ),
    sa.ForeignKeyConstraint(['cloud_sync_config_id'], ['cloud_sync_configs.id'], ),
    ...
    with op.batch_alter_table('jobs', schema=None) as batch_op:
        ...
        batch_op.create_index(batch_op.f('ix_jobs_job_uuid'), ['job_uuid'], unique=False)
