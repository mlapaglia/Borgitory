...
from dependencies import get_recovery_service, get_scheduler_service
...
async def lifespan(app: FastAPI):
    try:
        ...
        from services.archives.archive_mount_manager import get_archive_mount_manager
...
# Determine base path - in Docker we copy to root, in dev we use src/
