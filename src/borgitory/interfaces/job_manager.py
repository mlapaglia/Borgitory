...
class JobExecutor(Protocol):
    ...
    async def start_process(self, command: List[str], env: Optional[Dict[str, str]] = None) -> Any:
        """Start a process for the given command"""
        ...
    
    async def monitor_process_output(self, process: Any, output_callback: Optional[Any] = None) -> Any:
