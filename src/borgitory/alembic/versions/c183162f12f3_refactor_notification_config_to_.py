    ...
    if "apscheduler_jobs" in inspector.get_table_names():
        with op.batch_alter_table("apscheduler_jobs", schema=None) as batch_op:
            try:
                ...
                import logging
                logging.getLogger(__name__).warning(f"Could not get indexes for apscheduler_jobs: {e}")
        ...
        try:
            ...
            import logging
            logging.getLogger(__name__).warning(f"Could not drop apscheduler_jobs table: {e}")
