...
def upgrade() -> None:
    ...
    # Skip apscheduler_jobs operations - this table is managed by APScheduler, not Alembic
    # The include_object function in env.py already excludes it from future migrations
